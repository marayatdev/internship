...
?> โดยมีเวลารวมไม่น้อยกว่า 320 ชั่วโมง
                ...
                <p style="text-align: center;">จึงเรียนมาเพื่อโปรดพิจารณาอนุเคราะห์และขอบพระคุณเป็นอย่างยิ่งมา ณ โอกาสนี้</p>
        </div>
        <div class="right-img">
...
<script>
        function showAlertDialog() {
            Swal.fire({
                title: 'ยินดีต้อนรับ!',
                text: 'คลิก "ตกลง" เพื่อไปดาวน์โหลดไฟล์',
                icon: 'success',
